    ...
    <div id="bottom">
        ...
        <div id="playerlist">
            <form action="" method="post">
                ...
                Team #1:<select style="width:240px;border-radius:4px;margin-left:15px;height:26px;margin-bottom:20px">
                    <option>BBA</option>
                </select><br>
                Team #2:<select style="width:240px;border-radius:4px;margin-left:15px;height:26px;margin-bottom:20px">
                    <option>CSE</option>
                </select><br>
